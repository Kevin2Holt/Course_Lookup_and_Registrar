The instructions recommend using a readme file to test the pull request (collaboration) features.
To make things simple, just put your name below and then request a merge.
That way, we can all be sure that we understand how to do it.
